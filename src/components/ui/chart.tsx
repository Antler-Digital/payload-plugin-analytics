...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={cn("tw-font-xl", labelClassName)}>
      ...
      return <div className={cn("tw-font-xl", labelClassName)}>{value}</div>;
    }, [
      label,
      labelFormatter,
      payload,
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      className={cn(
                        "tw-flex tw-flex-1 tw-justify-between tw-leading-none italic tw-capitalize",
